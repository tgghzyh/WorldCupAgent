...
// Frontend shell mode: keep knowledge accessors available without importing
// currently corrupted JSON knowledge files.
const teamsKnowledge: TeamsKnowledge = {
  _metadata: {
    version: "frontend-shell",
    generated_at: "2026-07-07",
    description: "Temporary empty team knowledge store for UI shell",
    locale: "en",
  },
  teams: {},
};

const playersKnowledge: PlayersKnowledge = {
  _metadata: {
    version: "frontend-shell",
    generated_at: "2026-07-07",
    description: "Temporary empty player knowledge store for UI shell",
  },
  players: {},
};

const coachesKnowledge: CoachesKnowledge = {
  _metadata: {
    version: "frontend-shell",
    generated_at: "2026-07-07",
    description: "Temporary empty coach knowledge store for UI shell",
  },
  coaches: {},
};
 ...
 */
export function useTeamKnowledge(): TeamKnowledgeAccessor {
 ...
 */
export function usePlayerKnowledge(): PlayerKnowledgeAccessor {
 ...
 */
export function useCoachKnowledge(): CoachKnowledgeAccessor {
